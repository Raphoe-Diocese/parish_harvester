...
class OcrBulletinPageTests(unittest.TestCase):
    ...
    def test_extract_ocr_fragment_and_render_viewer_page(self) -> None:
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            self.assertIn("/assets/pdf-inpage-viewer.js?v=20260822c", html_output)
    ...
    def test_mobile_pdf_inpage_viewer_helpers(self) -> None:
        ...
        self.assertIn("/assets/pdf-inpage-viewer.js?v=20260822c", boot)
    ...
    def test_pdf_inpage_viewer_asset_streams_first_page(self) -> None:
        ...
        self.assertIn("pdf-inpage-viewer.js?v=20260822c", loader.read_text(encoding="utf-8"))
    ...
    def test_live_diocese_html_ships_inpage_viewer(self) -> None:
        ...
        for rel in (
            ...
            self.assertIn("/assets/pdf-inpage-viewer.js?v=20260822c", html_live, rel)
