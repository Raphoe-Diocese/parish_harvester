...
https://www.antrimparish.com
    ...
    def test_harvest_workflow_runs_tests_before_harvester(self) -> None:
        ...
        self.assertIn("mega_pdf/*_mega_bulletin.pdf", workflow)
    ...
    def test_deploy_pages_builds_extension_update_assets(self) -> None:
        ...
        self.assertIn('select((.name | test("mega-bulletin-pdf"; "i")) and (.expired == false))', workflow)
        ...
        self.assertIn("S2: harvest artifacts win", workflow)
