...
class DioceseIntroTests(unittest.TestCase):
    ...
    def test_viewer_shell_puts_intro_and_az_jump_above_the_boxes(self) -> None:
        ...
        self.assertIn('class="az-row"', html)
        ...
        # One compact letter row, not the tall grouped A–Z list it replaced.
        self.assertNotIn("az-jump-group", html)
        self.assertNotIn("az-jump-link", html)
        self.assertEqual(html.count('class="az-row"'), 2)
