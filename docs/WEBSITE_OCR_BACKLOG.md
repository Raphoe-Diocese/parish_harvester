...
- [x] **done** · 2026-08-23 · Back to Top arrow shows on INNER PDF/OCR scroll. Live-watched 23/08/2026 on https://www.parishpress.ie/dioceses/raphoe/ after PR #109 merge `608987c1` + Pages [32670926710](https://github.com/Raphoe-Diocese/parish_harvester/actions/runs/32670926710). Live HTML `Last-Modified: Sun, 23 Aug 2026 22:33:36 GMT`, script `pdf-inpage-viewer.js?v=20260823u`, button `data-pp-bound=inner-2`. Chrome on the live page: hidden at top (`windowY=0`); OCR box 848px / `scrollTop=240` → arrow **visible** (page stayed 0); click → OCR `scrollTop=0`, arrow hidden; PDF box 850px / `scrollTop=240` → arrow **visible** (page stayed 0); click → PDF `scrollTop=0`. · `harvester/site_chrome.py` `scroll_top_js`, `docs/assets/pdf-inpage-viewer.js`
...
- [ ] **doing** · 2026-08-23 · Diocese page intro: welcome; honest count; Facebook/website/stale lists. Heading must not say they “do not publish”. Every named parish gets a useful reader link only if already proved (recipe / status / live fetch this turn) — Facebook first (Mevagh, Gweedore `paroisteghaothdobhair`, Kilbarron recipe), else the parish website, else a proved official diocese parish page, else name-only. Do not invent URLs, phones, emails, or a this-week PDF. **Leave open until live** https://www.parishpress.ie/dioceses/raphoe/ shows the honest heading + Gweedore Facebook. · `harvester/diocese_intro.py`, `parishes/recipes/raphoe/gaoth-dobhair.json`
