...
- [ ] **doing** · 2026-08-22 · Homepage hero: add St Macartan's Cathedral, Monaghan (Catholic, CC BY-SA 4.0) with the other cathedral slides. Verified on generated `docs/index.html` 22/08/2026. Leave open until verified on live parishpress.ie · `harvester/site_builder.py` `HERO_SLIDES`
