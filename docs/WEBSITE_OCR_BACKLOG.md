...
- [ ] **doing** · 2026-08-23 · Recipe success — 13 Problems-tab parishes. **Clonleigh / Ballymoney / Glenariffe / Kincasslagh live ok**. **Clones harvest ok** (not live on parishpress): `parish_status` `outcome=ok`, url `https://www.clonesparish.com/uploads/downloads/Sunday%2023rd%20August%202026.pdf`. **Castleblayney doing** (not live ok): harvest [32667440113](https://github.com/Raphoe-Diocese/parish_harvester/actions/runs/32667440113) after PR #99 still `failed` — listing HTTPS urlopen dies on missing Sectigo chain; listing HTML has no PDF hrefs. Fix: HTTP/HTTPS listing, follow newest `/202` weekly-bulletin post, encode spaces, SSL fallback on CERTIFICATE_VERIFY_FAILED. Do not mark done until a harvest on main writes `parish_status` `outcome=ok` and url is the Aug 2026 Clontibret-Muckno PDF. **Ballinascreen done** (harvest ok, not live on parishpress): harvest [32670756157](https://github.com/Raphoe-Diocese/parish_harvester/actions/runs/32670756157) wrote `parish_status` `outcome=ok`, url `https://www.parishofballinascreen.com/ballinascreen-desertmartin-parishes-23_august_2026`. This-week HTML page is real (proved 23/08/2026) HTTP 200 `text/html` title `BALLINASCREEN & DESERTMARTIN PARISHES 23_AUGUST_2026`; recipe is wix_dated_slug + print_to_pdf (PR #104 SHA `78063f9859f254cc0d2f5837998cc6f8a0fa0b15`). Content gap: Bangor 14/06, Dunsford 05/07, Holy Cross (230826.pdf still 12/07 body), Malin April (August URL 404), Hannahstown 07/06, Saint Malachy’s Feb 2025, St Oliver 28/06, St Patrick’s 05/07, Stranorlar 28/06, Bundoran 09/02/2025 (Aug-folder URL 404; only Feb 2025 file on magheneparish.ie). Skip Carrick / Lisburn / Tyholland. · `parishes/recipes/`, `harvester/replay.py`, `harvester/utils.py` `quote_http_url`
...
- `/assets/pdf-inpage-viewer.js?v=20260823u` (cache-bust; live HTML stays older until harvest/OCR regenerates)
