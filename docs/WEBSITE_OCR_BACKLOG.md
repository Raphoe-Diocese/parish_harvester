...
- [ ] **doing** · 2026-08-23 · Put Ballycastle’s 23/08 bulletin (Enda / Edna Hill, printed spelling kept) on the public Parish Press pages. PR opened, wait for live Pages check. Do not mark done until live https://www.parishpress.ie/parishes/down_and_connor/ballycastleparish-ocr.html search for Enda Hill. · `docs/parishes/down_and_connor/ballycastleparish.pdf`, `docs/mega_pdf/down_and_connor_mega_bulletin.pdf` pages 5–6, `docs/bulletins/down_and_connor-*.html`
