...
- [ ] **doing** · 2026-08-22 · Add Clogher Diocese from official Expand-all directory (37 parishes). Facebook stays clickable. Auto-harvest only where a real weekly PDF was found. Do not mark the public Clogher page done until a harvest writes `docs/dioceses/clogher/` · `parishes/clogher_diocese_*`, `parishes/recipes/clogher/`, `parishes/dioceses.json`
